...
select throws_ok($$select public.backend_record_payment_attempt((select id from public.payments where booking_request_id='a2000000-0000-0000-0000-000000000001'),'initialAuthorization',2500,'auth-third','provider')$$,'55000','Initial authorization requires an accepted pending Card Payment.','additional initial authorization is rejected after Card authorization');
