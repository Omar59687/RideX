...
- Current checkpoint: 3R.1HC - Driver lifecycle concurrency correction
- Completed remediation checkpoints: 3R.0 documentation package; 3R.1 Driver lifecycle implementation (`6aa03fa`); 3R.1H Driver lifecycle verification hardening (`05610b6`) pending concurrency acceptance through 3R.1HC
- Exact next work: implement and verify 3R.1HC only; do not begin 3R.2
- Next migration/test: `016_phase3_driver_lifecycle_concurrency_correction.sql` and matching pgTAP file
- Immutable baseline: migrations/tests `001` through `015`
- Known limitations: 3R.1H's active-Trip check is not serialized with concurrent assignment, and its named concurrent-reservation assertion is sequential; 3R.1HC must close and genuinely test this boundary. The other eight confirmed gaps remain assigned to 3R.2 through 3R.4.
